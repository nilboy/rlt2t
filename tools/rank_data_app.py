...
class Model(object):
    ...
    def _update(self) -> None:
        ...
        output_texts_1_scores = calculate_scores(summaries, output_texts_1, bleu4_rate=1.0/3)
        output_texts_2_scores = calculate_scores(summaries, output_texts_2, bleu4_rate=1.0/3)
        gen_data = {}
        for i in range(len(self.records)):
