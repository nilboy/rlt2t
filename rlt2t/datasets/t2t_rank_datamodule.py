...
from rlt2t.datasets.t2t_rank_dataset import T2TRankDataset

class T2TRankDataModule(LightningDataModule):
    def __init__(self,
                 data_dir: str,
                 batch_size: int = 16,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.data_train or not self.data_val or not self.data_test:
            self.data_train = T2TRankDataset(os.path.join(self.data_dir, 'train.json'),
